...
import { getItemPool, getProductPool, getMaterialPool, getToolPool, getPartPool } from '../../api/pool'
...
export function* watchMasterPool() {
    const { itemLoad, productLoad, materialLoad, toolLoad, partLoad } = masterPoolAction;
